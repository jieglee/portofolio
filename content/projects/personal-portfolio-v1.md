...
|---|---|
| 🧱 HTML5 | Structuring all sections and content of the page |
| 🎨 CSS3 | Layout, styling, animations, and responsive design |
| ⚙️ JavaScript (Vanilla JS) | DOM manipulation and dynamic behavior |
| ⌨️ Typed.js | Animated typewriter effect in the hero section (via CDN) |
| 🔤 Font Awesome | Icons in the navbar, footer, and social media links (via CDN) |
| 📧 Formsubmit | Handling contact form submissions without a backend |
...
git clone https://github.com/jieglee/deploy-portofolio.git
```

Then open `index.html` directly — no build tools, no npm install required.
...
Thanks for taking a look back at where it all began! 💜